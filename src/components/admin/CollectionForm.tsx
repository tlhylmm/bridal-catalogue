...
export default function CollectionForm() {
    return (
        <form action={createCollection} style={{ maxWidth: '500px', display: 'grid', gap: '1.5rem' }}>
            <div>
                <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 700, marginBottom: '0.5rem' }}>Collection Name</label>
                <input name="name" type="text" required style={{ width: '100%', padding: '0.75rem', border: '1px solid #ccc' }} placeholder="e.g. 2025 Collection" />
            </div>
            <div>
                <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 700, marginBottom: '0.5rem' }}>Slug (URL)</label>
